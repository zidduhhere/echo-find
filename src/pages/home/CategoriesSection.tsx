            ...
            <div className="w-full px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative max-w-7xl mx-auto">
                    ...
                    <div
                        ...
                        className="flex pt-5 overflow-x-auto pb-6 snap-x snap-mandatory gap-6 hide-scrollbar"
                        style={{
                    ...
                    >
                        {categories.map((category) => (
                            ...
                            >
                                <div className={`bg-gradient-to-br ${category.gradient} p-8 h-full flex flex-col min-h-[320px]`}>
                                    <div className="rounded-full bg-white/20 w-20 h-20 flex items-center justify-center mb-8">
                                        {category.icon}
                                    </div>
                                    <h3 className="text-2xl font-bold text-white mb-4">{category.name}</h3>
                                    <p className="text-white/80 mb-auto">{category.description}</p>
                                    <button
                                        onClick={() => handleCategoryClick(category.id)}
                                        className="flex items-center text-white mt-6 group"
                                    >
                                        <span>Shop Now</span>
